...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-start justify-center w-full gap-5 px-4 py-6 rounded-t-lg bg-b-700 lg:flex-row lg:items-center lg:px-32 lg:gap-20 lg:pb-20 lg:pt-8 mt-40">
